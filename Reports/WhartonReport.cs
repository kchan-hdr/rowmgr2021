...
namespace ROWM.Reports
{
    public class WhartonReport : IRowmReports
    {
        ...
        static readonly IEnumerable<ColumnMapping> _atAGlance = new List<ColumnMapping>
        {
            ...
            new ColumnMapping{ TemplateColumnIndex = "E", TemplateColumnName = "USACOE ATP Sent to City", StatusCode = "USACOE_ATP_to_City" },
            new ColumnMapping{ TemplateColumnIndex = "F", TemplateColumnName = "Just Comp Approval Memo Sent to City", StatusCode = "Appraisal_JC_Memo" },
            new ColumnMapping{ TemplateColumnIndex = "G", TemplateColumnName = "City Just Comp Approved", StatusCode = "Appraisal_City_JC_Approved" },
            new ColumnMapping{ TemplateColumnIndex = "H", TemplateColumnName = "USACOE ATP Approved", StatusCode = "USACOE_ATP_Approved" },
            new ColumnMapping{ TemplateColumnIndex = "I", TemplateColumnName = "Offer Made", StatusCode = "Negotiation_Offer_Sent_Owner" },
            new ColumnMapping{ TemplateColumnIndex = "J", TemplateColumnName = "Counter Offer", StatusCode = "Negotiation_Counter_Offer" },
            new ColumnMapping{ TemplateColumnIndex = "K", TemplateColumnName = "PSA Signed", StatusCode = "PSA_Signed" },
            new ColumnMapping{ TemplateColumnIndex = "L", TemplateColumnName = "Closed", StatusCode = "Closing_Settlement" },
