...
namespace ROWM.Dal
{
    ...
    public class ParcelRepository
    {
        ...
        public ParcelGraph_Dto GetParcel(string pid) => 
            _ctx.Parcel.Where( px=> px.Assessor_Parcel_Number.Equals(pid))
        ...
        static ParcelRepository()
        {
            Mapper.Initialize(conf => {
                conf.CreateMap<Parcel, ParcelGraph_Dto>()
                    .ForMember(d=> d.ParcelId, o => o.MapFrom(s => s.Assessor_Parcel_Number));
                ...
                conf.CreateMap<Document, ParcelGraph_Dto.DocumentHeader>()
                    ...
                    .ForMember(d => d.AgentName, o => o.MapFrom(s => s.Agent.FirstOrDefault().AgentName));
            });
        }
        #endregion
    }
