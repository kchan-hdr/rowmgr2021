...
{
    public class SwanLakeParcel : FeatureService_Base, IFeatureUpdate, IRenderer
    {
        static readonly string _PARCEL_KEY = "Tracking_Number";
        readonly AgsSchema _layers;

        public SwanLakeParcel(string url = "")
        {
            _URL = string.IsNullOrWhiteSpace(url) ?
                "https://maps-stg.hdrgateway.com/arcgis/rest/services/Oregon/SwanLanke_Parcel_FS/FeatureServer"
                : url;
