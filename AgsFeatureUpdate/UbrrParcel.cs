...
{
    public class UbrrParcel : FeatureService_Base, IFeatureUpdate, IRenderer
    {
        static readonly string _PARCEL_KEY = "Assessor_Parcel_Number";

        public UbrrParcel(string url = "")
        {
            _URL = string.IsNullOrWhiteSpace(url) ?
                "https://maps-stg.hdrgateway.com/arcgis/rest/services/UBRY_Parcel_FS/FeatureServer"
                : url;
