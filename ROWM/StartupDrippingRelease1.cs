...
namespace ROWM
{
    public class StartupDrippingRelease1
    {
        public StartupDrippingRelease1(IHostingEnvironment env)
        {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var feat = new WhartonParcel("https://maps.hdrgateway.com/arcgis/rest/services/Texas/CoDS_Parcel_FS/FeatureServer");
            ...
            var appid = vaultClient.GetSecretAsync("https://drippingsprings-keys.vault.azure.net/", "app-id").GetAwaiter().GetResult();
            ...
            services.AddSingleton<SiteDecoration, Dripping>();
