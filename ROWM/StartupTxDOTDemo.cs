...
namespace ROWM
{
    public class StartupTxDOTDemo
    {
        public StartupTxDOTDemo(IHostingEnvironment env)
        {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var feat = new WhartonParcel("https://maps-stg.hdrgateway.com/arcgis/rest/services/Texas/TxDOT_Parcel_FS/FeatureServer");
            ...
            services.AddSingleton<SiteDecoration, TxDotDemo>();
