...
namespace ROWM.Dal
{
    ...
    /// </summary>
    public class UpdateParcelStatusNormal : IUpdateParcelStatus
    {
        ...
        public UpdateParcelStatusNormal(ROWM_Context context, OwnerRepository repository, IFeatureUpdate featureUpdate, IParcelStatusHelper h)
        {
