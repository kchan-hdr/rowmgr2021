...
namespace ROWM
{
    public class StartupRoseRelease1
    {
        public StartupRoseRelease1(IHostingEnvironment env)
        {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var feat = new RoseParcel("https://maps.hdrgateway.com/arcgis/rest/services/Oregon/RQ_Parcel_FS/FeatureServer");
            ...
            services.AddSingleton<SiteDecoration, RoseQuarter>();
