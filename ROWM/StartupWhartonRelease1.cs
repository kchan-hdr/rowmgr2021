...
namespace ROWM
{
    public class StartupWhartonRelease1
    {
        public StartupWhartonRelease1(IHostingEnvironment env)
        {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var feat = new WhartonParcel("https://maps.hdrgateway.com/arcgis/rest/services/Texas/CoW_Parcel_FS/FeatureServer");
