...
namespace geographia.ags
{
    ...
    {
        const string _PARCEL_KEY = "Tracking_Number";
        ...
        public async Task<IEnumerable<Status_dto>> GetAllParcels()
        {
            ...
            var req = $"{_URL}/{lid}/query?f=json&where=1=1&returnGeometry=false&returnIdsOnly=false&outFields=OBJECTID,{_PARCEL_KEY},ParcelStatus,ROE_Status,Documents";
        ...
        async Task<string> GetGlobalId(int lid, string q)
        {
            ...
            var r = await GetAll<string>(req, null);
        ...
        public async Task<bool> Update(ContactInfo_dto dto)
        {
            ...
            var req = JsonSerializer.Serialize(edits);
        ...
        public class ContactInfo_dto : ICloneable
        {
            ...
            [JsonPropertyName("REL_ParcelGlobalID")]
            public string ParentParcel_gid { get; set; }

            [JsonPropertyName("REL_OwnerGlobalID")]
        ...
        public class Status_dto
        {
            ...
            {
                public int? OBJECTID { get; set; }
                [JsonPropertyName(_PARCEL_KEY)]
                public string ParcelId { get; set; }
                public int? ParcelStatus { get; set; }
                public int? RoeStatus { get; set; }
