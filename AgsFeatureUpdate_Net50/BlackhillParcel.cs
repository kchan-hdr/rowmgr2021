...
{
    public class BlackhillParcel : FeatureService_Base, IFeatureUpdate
    {
        static readonly string _PARCEL_KEY = "PIN";

        public BlackhillParcel(string url = "")
        {
            // Staging: https://gis05s.hdrgateway.com/arcgis/rest/services/California/Blackhills_Parcel_FS/FeatureServer
            // Production: https://gis05s.hdrgateway.com/arcgis/rest/services/California/Blackhills_Parcel_FS/FeatureServer
            _URL = string.IsNullOrWhiteSpace(url) ?
                "https://gis05s.hdrgateway.com/arcgis/rest/services/California/Blackhills_Parcel_FS/FeatureServer"
                : url;
        ...
        public async Task<IEnumerable<Status_dto>> GetAllParcels()
        {
            ...
            //    return list;
            //});
            var r = await GetAll<Status_dto>(req, null);
        ...
        {
            var req = JsonSerializer.Serialize(u);
