...
{
    public class DenverParcel : FeatureService_Base, IFeatureUpdate
    {
        static readonly string _PARCEL_KEY = "PIN";

        public DenverParcel(string url = "")
        {
            // Staging: https://gis05s.hdrgateway.com/arcgis/rest/services/California/DW_Parcel_FS/FeatureServer
            // Production: https://gis05.hdrgateway.com/arcgis/rest/services/California/DW_Parcel_FS/FeatureServer
            _URL = string.IsNullOrWhiteSpace(url) ?
                "https://gis05s.hdrgateway.com/arcgis/rest/services/California/DW_Parcel_FS/FeatureServer"
                : url;
